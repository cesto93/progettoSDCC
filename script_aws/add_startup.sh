#!/bin/bash
SCRIPT="./startup/monitor.txt"
SCRIPT_BASE64="${SCRIPT}_base64.txt"
...
do
	...
	aws ec2 modify-instance-attribute --instance-id ${ID_MONITOR[$i]} --attribute userData --value file://$SCRIPT_BASE64
done
